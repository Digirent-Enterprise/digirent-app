// import { TEAMS } from "../../../utils/constants/image.constant";
    ...
    <div>
      <div className="h-48 sm:h-60 md:h-80 bg-[#F3F4F6] overflow-hidden rounded-lg shadow-lg mb-2 sm:mb-4 cursor-pointer group relative">
        <img
          ...
          loading="lazy"
          alt={alt}
          className="object-cover object-center w-full h-full duration-500 ease-in-out group-hover:rotate-6 group-hover:scale-125"
        />
      </div>
