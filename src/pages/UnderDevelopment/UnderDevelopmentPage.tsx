...
const UnderDevelopmentPage = () => {
  return (
    <DefaultLayout>
      <div className="lg:px-24 lg:py-24 md:py-20 md:px-16 px-4 py-24 items-center flex justify-center flex-col-reverse lg:flex-row md:gap-18 gap-16">
        <div className="xl:pt-24 w-full xl:w-1/2 relative pb-12 lg:pb-0">
          <div className="relative">
            <div className="">
              ...
              <div className="flex">
                <span className="animate-waving-hand text-4xl pb-4 pr-4">
                  👋🏻
                </span>
                <Menu>
